...
//        }
        ...
        if(list.get(0).get("position").toString().equals("1")){
            ...
            if(other_location_list.size()==0){
                ...
                resultParamJson.put("other_count",0);
            }else {
                ...
                resultParamJson.put("other_count",all_other_location.size());
            }
        }else {
            resultParamJson.put("other_location",new JSONObject());
            resultParamJson.put("other_count",0);
        ...
        contain = fingerprintDatabase.allContain();
